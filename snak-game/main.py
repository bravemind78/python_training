...
def keyboard_pressed():
    screen.onkey(turn_snake_north,"Up")
    screen.onkey(turn_snake_east,"Right")
    screen.onkey(turn_snake_west,"Left")
    screen.onkey(turn_snake_south,"Down")
# ---------------------------------------------------------------------------- #
...
# ------------------ to do next تخصيص مفاتيح الكيبورد لعمل هذة الحركات ------------------ #
